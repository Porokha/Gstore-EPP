...
function gstore_typography_page(){
	...
	if (isset($_POST['gstore_typography_submit'])) {
		...
		update_option('gstore_typography_options', $options);
        ...
        jQuery(document).ready(function($){
            ...
            $('.upload-font-btn').on('click', function(e){
                ...
                var mediaUploader = wp.media({
                    ...
                    library: {
                        type: ['application/font-woff2', 'application/font-woff', 'application/x-font-ttf', 'font/woff2', 'font/woff', 'font/ttf']
                    },
                    multiple: false
                });
                ...
                mediaUploader.on('select', function(){
                    ...
                    button.next('.remove-font-btn').show();
                });
