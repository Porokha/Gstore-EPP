...
(function(){
    ...
    function mount(){
        ...
        function AnimatedNumber(props){
            ...
            return e("span", {
                ...
                style: {
                    ...
                    color: isAnimating ? '#d1d5db' : 'inherit', // Light gray-300 for flash effect
                    textShadow: isAnimating ? '0 0 10px rgba(255, 255, 255, 0.9)' : 'none' // Glowing flash effect
                }
        ...
        function ProductApp(){
            ...
            // Countdown timer for scenario 3
            useEffect(function(){
...
// Get shipping time and warehouse from BOOT
                ...
                return e("div",{className:"min-h-screen bg-white pb-24"},[
                    e("div",{key:"mobile-content",className:"py-2 space-y-3"},[
                                ...
                                colors.map(function(c){
                                    ...
                                    return e("div",{
                                        ...
                                        style:{
                                            ...
                                            animation:active ? 'glow-rotate 5s linear infinite' : 'none'
                                        }
                                    }, e("img",{
                                        src:c.image,
                                        alt:c.color||'color',
                        ...
                        BOOT.shortDescription && e("div",{key:"desc",className:"text-gray-700 text-sm leading-relaxed bg-gray-50 border border-gray-100 rounded-lg p-3"},[
                            e("div",{"data-gstore-short-description":"",dangerouslySetInnerHTML:{__html:BOOT.shortDescription}})
                        ]),
                        ...
                        e("div",{key:"tabs"},[
                            ...
                            activeTab && e("div",{className:"pt-2 text-sm text-gray-700"},[
                                activeTab==='specifications' && (BOOT.description
                                    ? e("div",{"data-gstore-description":"",className:"gstore-description-wrapper",dangerouslySetInnerHTML:{__html:BOOT.description}})
                    ...
                    (showChallenge === true && challengeScreen !== null) && e("div",{key:"challenge-modal",className:"gstore-modal-overlay",style:{paddingTop:'80px'},onClick:function(){if(challengeScreen!=='intro')setShowSurrenderWarning(true);else closeChallenge();}},[
                        ...
                        challengeScreen==='level2' && e("div",{key:"level2",className:"gstore-modal-content",style:{maxWidth:'512px'},onClick:function(ev){ev.stopPropagation();}},[
            ...
            return e("div",{className:"min-h-screen bg-white"},[
                e("div",{key:"main",className:"max-w-7xl mx-auto p-6 grid lg:grid-cols-2 gap-8"},[
                    ...
                    showOfferPopup && uniqueOffers.length > 0 && e("div",{key:"offer-modal",className:"gstore-modal-overlay",onClick:function(){
                        if(offerScenario !== 3){
                            setShowOfferPopup(false);
                        ...
                        e("div",{key:"modal",className:"gstore-modal-content",style:{maxWidth:'650px'},onClick:function(ev){ ev.stopPropagation(); }},[
                            e("div",{key:"header",style:{background:'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',color:'white',padding:'24px',borderRadius:'12px 12px 0 0',position:'relative'}},[
                                ...
                                e("div",{key:"icon",style:{fontSize:'48px',marginBottom:'12px'}},offerScenario === 3 ? "🎉" : "🔥"),
                                e("h2",{key:"title",style:{fontSize:'24px',fontWeight:'700',marginBottom:'8px'}},offerScenario === 3 ? "Special Discount!" : "Special Offer"),
        ...
        try {
            ...
            // Load and inject modal styles from external CSS file
            var modalCssUrl = GSTORE_BOOT.urls.assets + '/css/modal-styles.css';
            fetch(modalCssUrl)
                ...
                .then(function(css) {
                    ...
                    console.log('✅ Modal styles loaded into Shadow DOM');
                })
                .catch(function(error) {
                    console.warn('⚠️ Could not load modal styles:', error);
                });
