...
add_action('wp_enqueue_scripts', function(){
	...
	$boot = [
		...
		'hasAddRAM'  => !empty(gstore_epp_attr($pid, 'add_ram')) || !empty(gstore_epp_attr($pid, 'add-ram')),
		'hasAddStorage' => !empty(gstore_epp_attr($pid, 'add_storage')) || !empty(gstore_epp_attr($pid, 'add-storage')),
		'image'      => $hero,
		'gallery'    => $gallery,
